...
body = dbc.Container([
    ...
    dbc.Row([
            ...
            dbc.Col([
                # dcc.Markdown('grafico aqui')
                dcc.Graph(figure=plots.gr_ipca(), style=pl_styles)
            ])
            ]),
    # Dados de comércio
    html.H2('Comércio'),
    dbc.Row([
        ...
        dbc.Col([
            dcc.Markdown('grafico aqui')
            # dcc.Graph(figure=plots.gr_pmc(), style=pl_styles)
        ]),
    ]),
    # Dados de serviços
    html.H2('Serviços'),
    dbc.Row([
        ...
        dbc.Col([
            dcc.Markdown('grafico aqui')
            # dcc.Graph(figure=plots.gr_pms(), style=pl_styles)
        ]),
    ]),
    # Preços ao produtor
    html.H2('Produção'),
    dbc.Row([
        ...
        dbc.Col([
            dcc.Markdown('grafico aqui')
            # dcc.Graph(figure=plots.gr_pimpf(), style=pl_styles)
        ])
    ]),
    ...
    dbc.Row([
            ...
            dbc.Col([
                dcc.Markdown('grafico aqui')
                # dcc.Graph(figure=plots.gr_focus(), style=pl_styles)
            ])
            ]),
    # Dólar PTAX
    html.H2('Dólar'),
    dbc.Row([
        ...
        dbc.Col([
            dcc.Markdown('grafico aqui')
            # dcc.Graph(figure=plots.gr_ptax(), style=pl_styles)
        ]),
    ]),
    ...
    dbc.Row([
        ...
        dbc.Col([
            dcc.Markdown('grafico aqui')
            # # dcc.Graph(figure=plots.gr_comb_intl(), style=pl_styles)
        ]),
    ]),
    # Grãos
    html.H2('Grãos'),
    dbc.Row([
        ...
        dbc.Col([
            dcc.Markdown('grafico aqui')
            # dcc.Graph(figure=plots.gr_graos(), style=pl_styles)
        ]),
    ]),
    # Animais
    html.H2('Animais'),
    dbc.Row([
        ...
        dbc.Col([
            dcc.Markdown('grafico aqui')
            # dcc.Graph(figure=plots.gr_animais(), style=pl_styles)
        ]),
    ]),
    # Metais
    html.H2('Metais'),
    dbc.Row([
        ...
        dbc.Col([
            dcc.Markdown('grafico aqui')
            # dcc.Graph(figure=plots.gr_metais(), style=pl_styles)
        ]),
    ]),
    # Gás natural
    html.H2('Gás natural'),
    dbc.Row([
        ...
        dbc.Col([
            dcc.Markdown('grafico aqui')
            # dcc.Graph(figure=plots.gr_gasnat(), style=pl_styles)
        ])
    ]),
    html.Footer([
        'aaa'
